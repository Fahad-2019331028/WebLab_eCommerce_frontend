  ...
  return (
    <div className="orderScreenHolder">
      ...
      {!logState ? (
        ...
        <h2 style={{ fontSize: "35px" }}>Order list</h2>
      )}

      {
        <div className="row justify-content-center">
          ...
          {orders &&
            orders.map((order) => {
              return (
                <div className="col-md-8 pp shadow-lg p-3 mb-1 bg-white rounded">
                  <div className="flex-container">
                    <div className="text-left w-100 m-1 ">
                      <h2 style={{ fontSize: "15px" }}>Order items</h2>
                      {order.orderItems.map((item) => {
                        return (
                          <div>
                            <h1>
                              {" "}
                              {item.name}[*{item.quantity}] = {item.prices}
                            </h1>
                          </div>
                        );
                      })}
                    ...
                    <div className="text-left w-100 m-1 ">
                      <h2 style={{ fontSize: "15px" }}>Customer info</h2>
                    ...
                    <div className="text-left w-100 m-1 pp2">
                      ...
                      <br></br>
                      <ch1> Trx ID: {order.transactionId.slice(12)}</ch1>
                      <br></br>
                      <br></br>
                      <br></br>
...

                          {
                            <Modal show={show} className="modal modal_window">
                              ...
                              >
                                ...
                                <hr id="sphr"></hr>
                                <p className="pMsg ">
                                  {"IF You Confirm this Order  " +
                                    " A Supply Request will be sent to supplier with the transaction number "}
                                </p>
                                <p className="pMsg2 ">
                                  {"Also "}
